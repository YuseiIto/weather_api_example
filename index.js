...
1.Creat Http Request object to access the URL-> 2.Create URL ->2a. set YOUR API KEY->2b. Basic URL
*/
...
function CreateRequestURL() {
    ...
    let API_KEY = "a667419e22e31d4ca461f3cd68df70df" //2a. set YOUR API KEY
    let BASE_URL = "http://api.openweathermap.org/data/2.5/weather" //2b. Basic URL
    let city = "1655078" //2c. city id  you want to request.
